  ...
  <div className="flex flex-col lg:flex-row items-center mt-10 md:mt-20 px-4 md:px-6 lg:px-6">
    <div className="lg:w-6/12 ">
      ...
      <div className="lg:w-6/12 flex justify-center lg:justify-start items-center gap-2 md:gap-5 lg:gap-3 mt-10">
        <Link to="/" className="bg-blue100 hover:bg-white hover:border hover:border-blue100 text-white hover:text-blue100 py-2 px-4 rounded-md">Start your journey</Link>
        <Link to="/" className="py-2 px-4 shadow border border-gray100 hover:bg-blue100 hover:text-white rounded-md">Discover more</Link>
      </div>
    </div>
