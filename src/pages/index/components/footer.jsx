...
const Footer = () => (
  <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-7 md:gap-0 bg-blue100 text-white justify-between p-10 mt-20">
    ...
    <div className="">
      ...
      <p className="text-gray100 mt-1 md:mt-3 lg:w-8/12 text-sm">123 Freedom way Unity District Lagos Nigeria</p>
    ...
    <div className="">
      ...
      <li>
        <Link href="/about" className="text-gray100 hover:text-white">
          About Us
        </Link>
      </li>
      <li>
        <Link href="/our-story" className="text-gray100 hover:text-white">
          Our Story
        </Link>
      </li>
      <li>
    ...
    <div className="">
      ...
      <form className="subscribe border rounded-md mt-1 md:mt-3 overflow-hidden">
        ...
        />
        <button type="submit" className="bg-white text-black w-3/12 py-1 hover:bg-blue200 hover:text-white">
          Join
        </button>
      </form>
    </div>
